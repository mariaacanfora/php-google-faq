...
<body>
    <header>
        <nav class="navbar navbar-light bg-light pb-0">
            <div class="container-fluid justify-content-start align-items-baseline">
                ...
                <span class="text-decoration-none text-secondary fs-4 flex-grow-1">Privacy e termini</span>
            ...
            <div class="container-fluid">
                <ul class="p-0 m-0">
                    <?php
                    foreach ($navLinks as $k => $link) {

                        if ($k === (count($navLinks) - 1)) {
                            echo "<li class='d-inline-block border-bottom border-5 border-primary'><a href='#' class='text-decoration-none text-dark'> $link </a></li>";
                        } else {
    ...
    <main>
        <div class="container">
            ...
            foreach ($parList as $key => $item) {
                ...
                if ($parList[$key]["haveSubtitle"]) {
                    echo $parList[$key][0];
                    /* echo "<pre>";
                        var_dump($parList[$key][0]);
                        echo "</pre>"; */
                    echo "<ol>";
                    foreach ($parList[$key]['orderedList'] as $j => $par) {
                        echo "<li>";

                        /* echo "<pre>";
                                    var_dump($parList[$key]['orderedList']);
                                    echo "</pre>"; */

                        echo $j;
                        if (!empty($parList[$key]['orderedList'][$j])) {
                            echo "<ul>";
                            foreach ($parList[$key]['orderedList'][$j] as $value) {
                                echo "<li>";
                                echo $value;
                                echo "</li>";
                            }
    ...
    <footer class="bg-lt-grey py-3">
        <div class="container  d-flex justify-content-between">
            <ul class="m-0 p-0 flex-grow-1">
                <li class="d-inline-block pe-2"><a href="#">Google</a></li>
                <li class="d-inline-block pe-2"><a href="#">Tutto su Google</a></li>
                <li class="d-inline-block pe-2"><a href="#">Privacy</a></li>
                <li class="d-inline-block pe-2"><a href="#">Termini</a></li>
            </ul>

            <div style="width: 15%;" class="d-flex align-items-center">
                <i class="fas fa-globe-africa pe-2 text-primary"></i>
